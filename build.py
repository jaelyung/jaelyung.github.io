...
LOCALES = {
    "en": {
        ...
        "lead": "Study Japanese words from JLPT N5 to N1 in 10-question sets. Missed words return for review, with example sentences, reading guides, and pronunciation. Pocket Word also offers HSK vocabulary practice for Chinese learners.",
        ...
        "features": [
            ...
            ("Quiz and review", "Finish a focused set of 10 questions. Words you miss come back for review, so you can practice them again."),
        ...
        "faq": [
            ...
            ("How long is a study session?", "Each study set has 10 questions, so you can practice JLPT vocabulary in a short break."),
            ("How can I review words I missed?", "Missed words return automatically for review. You can also review them after a quiz, save favorites, or find words in the vocabulary list."),
    ...
    "ko": {
        ...
        "lead": "JLPT N5부터 N1까지 일본어 단어를 10문제씩 공부하세요. 틀린 단어는 다시 출제되며 예문, 한자 읽기, 발음 듣기를 지원합니다. 중국어 학습자를 위한 HSK 포켓 단어도 함께 소개합니다.",
        ...
        "features": [
            ...
            ("퀴즈와 오답 복습", "10문제씩 집중해서 풀고, 틀린 단어가 다시 나오면 반복해서 익힐 수 있습니다."),
            ("검색과 발음 듣기", "단어장 검색, 읽기와 예문 확인, 즐겨찾기, 발음 듣기로 단어를 익혀 보세요."),
        ],
        "gallery_eyebrow": "앱 미리보기", "gallery_title": "학습 화면 살펴보기",
        "gallery_intro": "레벨별 학습 현황부터 매일 알림까지, JLPT 포켓 단어: 내 손안의 일본어 단어장의 한국어 화면입니다.",
        ...
        "jlpt_name": "JLPT 포켓 단어: 내 손안의 일본어 단어장", "jlpt_copy": "JLPT 레벨별 일본어 단어를 퀴즈, 후리가나, 예문, 즐겨찾기, 복습으로 학습하세요.",
        ...
        "faq": [
            ("JLPT 포켓 단어: 내 손안의 일본어 단어장은 어떤 앱인가요?", "일본어 학습자를 위한 iPhone 단어 앱입니다. JLPT N5부터 N1까지 단어를 레벨별로 학습하며 퀴즈, 복습, 발음, 예문 기능을 사용할 수 있습니다."),
            ("한 번에 몇 문제를 공부하나요?", "한 세트는 10문제로 구성되어 있어 짧은 시간에도 JLPT 단어를 공부할 수 있습니다."),
            ("틀린 단어는 어떻게 복습하나요?", "틀린 단어는 다시 출제되어 반복해서 익힐 수 있습니다. 퀴즈 결과에서 복습하거나 즐겨찾기에 저장하고 단어장에서 찾아볼 수도 있습니다."),
    ...
    "zh-CN": {
        ...
        "lead": "按 JLPT N5 至 N1 级别学习日语词汇，每组完成 10 道题。答错的单词会再次出现，还可查看例句、假名读音并听发音。页面也介绍 HSK Pocket Word。",
        ...
        "features": [
            ...
            ("测验与错题复习", "每组完成 10 道题；答错的单词会再次出现，帮助你反复巩固。"),
            ("查词与听发音", "搜索词汇、查看读音和例句、收藏单词，并播放发音。"),
        ],
        "gallery_eyebrow": "应用预览", "gallery_title": "看看学习过程",
        "gallery_intro": "以下是 JLPT口袋单词：掌上日语单词本的简体中文 iPhone 预览图。",
        ...
        "jlpt_name": "JLPT口袋单词：掌上日语单词本", "jlpt_copy": "按 JLPT 级别学习日语词汇，使用测验、假名标注、例句、收藏与复习功能。",
        "hsk_name": "HSK Pocket Word", "hsk_copy": "通过简短测验和反复复习练习 HSK 汉语词汇。",
        "app_cta": "在 App Store 查看",
        "faq_eyebrow": "常见问题", "faq_title": "了解 Pocket Word",
        "faq": [
            ("JLPT口袋单词：掌上日语单词本是什么？", "这是一款面向日语学习者的 iPhone 词汇应用，按 JLPT N5 至 N1 分级，提供测验、复习、发音和例句。"),
            ("每组测验有多少题？", "每组包含 10 道题，方便利用短暂休息时间练习 JLPT 词汇。"),
            ("怎样复习答错的单词？", "答错的单词会再次出现，供你反复练习。也可以在测验结果中复习、收藏单词，或在词汇列表中查找。"),
    ...
    "zh-TW": {
        ...
        "lead": "按 JLPT N5 至 N1 級別學習日文單字，每組練習 10 題。答錯的單字會再次出現，還可查看例句、假名讀音並聆聽發音。頁面也介紹 HSK Pocket Word。",
        ...
        "features": [
            ...
            ("測驗與錯題複習", "每組練習 10 題；答錯的單字會再次出現，幫助你反覆鞏固。"),
            ("查字與聽發音", "搜尋單字、查看讀音與例句、加入最愛，並播放發音。"),
        ],
        "gallery_eyebrow": "應用程式預覽", "gallery_title": "看看學習流程",
        "gallery_intro": "以下是 JLPT 口袋單字：日文學習與日檢的繁體中文（台灣）iPhone 預覽圖。",
        ...
        "jlpt_name": "JLPT 口袋單字：日文學習與日檢", "jlpt_copy": "按 JLPT 級別學習日文單字，使用測驗、假名標註、例句、收藏與複習功能。",
        "hsk_name": "HSK Pocket Word", "hsk_copy": "透過簡短測驗和反覆複習練習 HSK 中文單字。",
        "app_cta": "在 App Store 查看",
        "faq_eyebrow": "常見問題", "faq_title": "認識 Pocket Word",
        "faq": [
            ("JLPT 口袋單字：日文學習與日檢是什麼？", "這是一款供日文學習者使用的 iPhone 單字應用程式，按 JLPT N5 至 N1 分級，提供測驗、複習、發音與例句。"),
            ("每組測驗有幾題？", "每組包含 10 題，方便利用短暫休息時間練習 JLPT 單字。"),
            ("如何複習答錯的單字？", "答錯的單字會再次出現，供你反覆練習。也可以在測驗結果中複習、收藏單字，或在單字列表中搜尋。"),
    ...
    "vi": {
        ...
        "lead": "Học từ vựng tiếng Nhật từ JLPT N5 đến N1 theo từng bộ 10 câu hỏi. Từ trả lời sai sẽ xuất hiện lại để ôn tập; ứng dụng có câu ví dụ, cách đọc và phát âm. Trang này cũng giới thiệu HSK Pocket Word.",
        ...
        "features": [
            ...
            ("Làm bài và ôn từ sai", "Luyện theo từng bộ 10 câu hỏi. Từ trả lời sai sẽ xuất hiện lại để bạn luyện tập thêm."),
        ...
        "gallery_intro": "Ảnh xem trước JLPT Pocket Word: Tiếng Nhật trên iPhone với giao diện tiếng Việt.",
        ...
        "jlpt_name": "JLPT Pocket Word: Tiếng Nhật", "jlpt_copy": "Học từ vựng tiếng Nhật theo cấp độ JLPT qua bài kiểm tra, cách đọc furigana, câu ví dụ, từ yêu thích và ôn tập.",
        ...
        "faq": [
            ("JLPT Pocket Word: Tiếng Nhật là gì?", "Đây là ứng dụng từ vựng trên iPhone dành cho người học tiếng Nhật. Từ được chia theo cấp độ JLPT N5 đến N1, kèm bài kiểm tra, ôn tập, phát âm và câu ví dụ."),
            ("Mỗi lần học có bao nhiêu câu hỏi?", "Mỗi bộ học gồm 10 câu hỏi, phù hợp để luyện từ vựng JLPT trong một khoảng nghỉ ngắn."),
            ("Làm sao để ôn những từ trả lời sai?", "Từ trả lời sai sẽ xuất hiện lại để bạn luyện tập. Bạn cũng có thể ôn ở màn hình kết quả, lưu từ yêu thích hoặc tìm trong danh sách từ vựng."),
...
def page(locale, d):
    ...
    shots = "".join(
        f'<figure class="shot"><img src="/images/{image_locale}/{i}.webp" width="1183" height="2441" loading="lazy" decoding="async" alt="{e(d["jlpt_name"] + " — " + caption)}"><figcaption>{e(caption)}</figcaption></figure>'
